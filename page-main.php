...
$id = get_the_ID();
?>
<section class="section-banner" style="background: url('<?php echo wp_get_attachment_image_url(carbon_get_post_meta($id,'slider_background'),'full');?>') no-repeat center;background-size: cover;">
    <div class="container">
        <div class="row align-items-center width-content">
            <div class="col-xl-7 col-lg-7 wow flipInX">
                <h1><?php echo carbon_get_post_meta($id,'slider_title');?></h1>
                <p class="description-b"><?php echo carbon_get_post_meta($id,'slider_desc');?></p>
            ...
            <div class="col-xl-5 col-lg-5 d-flex justify-content-end banner-img  wow fadeInRight">
                <?php echo wp_get_attachment_image(
                    carbon_get_post_meta($id,'slider_img'),
                    'full',
                    false,
                    [
                        'class'=>'img-fluid',
                        'alt'=>carbon_get_post_meta($id,'slider_title')
                    ]
                );?>
            </div>
        </div>
        ...
        <div class="row width-content">
            <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                <div class="block-description wow flipInX">
                    <h2><?php echo carbon_get_post_meta($id,'price_title');?></h2>
                    <h3><?php echo carbon_get_post_meta($id,'price_desc');?></h3>
                </div>
            </div>
        </div>
        <div class="row align-items-center width-content">
            <?php $prices = carbon_get_post_meta( $id,'price_block');
            foreach ($prices as $price):?>
                <div class="col-xl-4 col-lg-4 col-md-12">
                    <div class="service wow fadeInLeft" data-wow-delay="0.2s">
                        ...
                        <h3><?php echo $price['pac_title'];?></h3>
                        <p class="service-description"><?php echo $price['pac_desc'];?></p>
                        <a href="<?php echo $price['pac_link'];?>" class="service-link"><?php echo esc_attr( pll__( 'детальніше' ) ) ?></a>
                    </div>
                </div>
            <?php endforeach;?>
        </div>
    ...
    <div class="container">
        <div class="row width-content white">
            <div class="col-xl-12 col-lg-12  wow fadeInUp">
                <h2 class="content-section-contact"><?php echo carbon_get_post_meta($id,'seo_title');?></h2>
