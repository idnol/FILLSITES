...
$id = get_the_ID();
?>
<section class="section-banner" style="background: url('<?php echo wp_get_attachment_image_url(carbon_get_post_meta($id,'page_service_slider_background'),'full');?>') no-repeat center;background-size: cover;">
    <div class="container">
        <div class="row align-items-center width-content">
            <div class="col-xl-7 col-lg-7 wow flipInX">
                <h1><?php echo carbon_get_post_meta($id,'page_service_slider_title');?></h1>
                <p class="description-b"><?php echo carbon_get_post_meta($id,'page_service_slider_desc');?></p>
            ...
            <div class="col-xl-5 col-lg-5 d-flex justify-content-end banner-img  wow fadeInRight">
                <?php echo wp_get_attachment_image(
                    carbon_get_post_meta($id,'page_service_slider_img'),
                    'full',
                    false,
                    [
                        'class'=>'img-fluid',
                        'alt'=>carbon_get_post_meta($id,'page_service_slider_title')
                    ]
                );?>
            </div>
        </div>
...
<section class="section-about-service padding-block grey">
    <div class="container">
        <div class="row width-content align-items-center">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 page-first-text single-page-title">
                <div class="block-description wow flipInX easy-margin">
                    <h2><?php the_title();?></h2>
                    <h3><?php echo carbon_get_post_meta($id,'page_service_about_desc');?></h3>
                </div>
            </div>
            <div class="col-xl-12">
                <?php the_content();?>
        ...
        <div class="row width-content">
            <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                <div class="block-description wow flipInX">
                    <h2><?php echo carbon_get_post_meta($id,'page_service_benefits_title');?></h2>
                    <h3><?php echo carbon_get_post_meta($id,'page_service_benefits_desc');?></h3>
                </div>
            </div>
        </div>
        <div class="row align-items-center width-content wow fadeInLeft" data-wow-delay="0.2s">
            <?php $benefits = carbon_get_post_meta( $id,'page_service_benefits_block');
            foreach ($benefits as $benefit):?>
                <div class="col-xl-4 col-lg-4 col-md-12">
                    <div class="service benefits">
                        <?php echo wp_get_attachment_image(
                            $benefit['page_service_benefits_img'],
                            'full',
                            false,
                            [
                                'class'=>'service-icon',
                        ...
                        <h3><?php echo $benefit['page_service_benefits_title'];?></h3>
                        <p class="service-description"><?php echo $benefit['page_service_benefits_desc'];?></p>
                    </div>
                </div>
            <?php endforeach;?>
        </div>
    ...
    <div class="container">
        ...
        <div class="row align-items-center width-content">
            <div class="col-xl-12 col-lg-12 slider-item wow fadeInUp" data-wow-delay="0.2s">
                ...
                $i=carbon_get_post_meta($id, 'service_set_road');
                $j=carbon_get_post_meta($id, 'service_set_type');
                $k=carbon_get_post_meta($id, 'service_set_technology');
                foreach ($cases as $case):
                    if ($case['case_set_road'][0]==$i[0] && $case['case_set_type'][0]==$j[0] && $case['case_set_technology'][0]==$k[0]) { ?>
...
<section class="technology padding-block">
    <div class="container">
        <div class="row align-items-center width-content">
            <div class="block-description wow flipInX">
                <h2 class="white">Используемые технологии</h2>
    ...
    <div class="container">
        <div class="row width-content white">
            <div class="col-xl-12 col-lg-12  wow fadeInUp">
                <h2 class="content-section-contact"><?php echo carbon_get_post_meta($id,'page_services_seo_title');?></h2>
                <div class="white"><?php echo carbon_get_post_meta($id,'page_services_seo_description');?></div>
            </div>
        </div>
    </div>
</section>
